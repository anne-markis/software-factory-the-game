...
named Plan item sizes plus that unshipped work, not the idle Ideas
wallet. Unique Pursue offers auto-enter Plan once legal. The Delivery
diagram paints Ideas and Plan left of Ready, then Ready →
